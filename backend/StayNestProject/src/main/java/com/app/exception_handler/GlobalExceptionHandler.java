...
@RestControllerAdvice //declaring spring bean containing cross cutting concerns(repetative logic) of exc handling
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handleInvalidInputException(InvalidInputException e) {
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ApiResponse(e.getMessage()));//sc400
		}
